<template>
  <div>
        ...
        <div class="card border-0 shadow-sm">
          ...
          <div class="card-footer d-flex">
            ...
            <button type="button" class="btn btn-outline-danger btn-sm ml-auto"
              ...
              <i class="fas fa-spinner fa-spin" v-if="status.loadingItem === item.id"
              ></i>
              加到購物車
            </button>
          </div>
    ...
    <!-- 建立訂單 -->
    <div class="my-5 row justify-content-center">
  <form class="col-md-6 text-left" @submit.prevent="createOrder" >
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <img :src="product.image || product.imageUrl" class="img-fluid" alt="">
...
export default {
  ...
  methods: {
    ...
    addtoCart(id,qty = 1){
      ...
      vm.axios.post(url,{ data:cart }).then((response) => {
        console.log(response.data)
        vm.status.loadingItem = '';
        vm.getCart();
    ...
    addCouponCode(){
      ...
      vm.isLoading = true;
      vm.axios.post(url,{data:coupon}).then((response) => {
        console.log(response.data)
        vm.getCart();
        vm.isLoading = false;
      });
